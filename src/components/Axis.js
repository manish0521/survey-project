...
// import '../Axis.css'
// //import window.d3 from 'react-window.d3-library';
...
//         window.d3.select(this.axisElement)
//             .call(axis)
//     }
//     render(){
//         return (
...
//     constructor(props){
//         super(props);
//         this.colorScale = window.d3.scaleLinear()
...
//         let bar = window.d3.select(node).append("g");
...
//             .transition().duration(1500).ease(window.d3.easeElastic)
//             .attr("x",(d) => xScale(d.month))
...
//         window.d3.select(".rect-group").remove();
//         bar.attr("class","rect-group")
//             .selectAll("rect")
//             .data(data)
//             .enter()
...
//             .attr("x",(d) => xScale(d.month))
//             .attr("y",(d) => height - margins.bottom)
//             .transition().duration(2500).ease(window.d3.easeElastic)
//             .attr("x",(d) => xScale(d.month))
//             .attr("y",(d) => yScale(d.income))
//             .attr("width",xScale.bandwidth())
//             .attr("height",(d) => height - yScale(d.income) - margins.bottom)
...
//         window.d3.select(".text-group").remove();
//         bar.append("g")
...
//    const xScaleMonth = window.d3.scaleBand()
...
//     const {xScale,yScale} = scales;
//     let bisectMouseValue = window.d3.bisector((d) => d.year).left;
...
//                  window.d3.select(".lineChartTooltip").attr("transform","translate("+ xScale(d.year)+","+yScale(d.income)+")");
//                  window.d3.select(".lineChartTooltip line").attr("y2",svgDimensions.height- yScale(d.income) - margins.bottom);
//                  window.d3.select(".lineChartTooltip text").text(d.income)
//                  this.setState({
//                      year: d.year
//                  });
//              }}
//              onMouseOut={() => {
//                  window.d3.select(".lineChartTooltip").attr("transform","translate("+ translateX+","+translateY+")");
//                  window.d3.select(".lineChartTooltip line").attr("y2",svgDimensions.height- translateY - margins.bottom)
//                  window.d3.select(".lineChartTooltip text").text(data[2].income)
//                  this.setState({
...
//     )
//    const rectOverlay = <rect transform={`translate(${margins.left/2},${margins.top/2})`} className="rectOverlayLineChart" width={svgDimensions.width - margins.right } height={svgDimensions.height - margins.top} rx="5" ry="5"/> 
...
//          svgDimensions = { height: window.innerHeight, width: window.innerWidth};
//     return ( 
//       <div className="chart">
//                 <div className="lineChart">
//                     <LineChartComponent margins={margins} svgDimensions={svgDimensions} data={this.state.lineChartData} onChangeYear={this.handleChangeYear.bind(this)} />
//                 </div>
